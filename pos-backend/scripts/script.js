...
const dishesData = [
  // --- Existing Dishes (from previous list) ---
  {
  ...
  // Rice
  {
    ...
    name: "Plain Rice",
    numberOfOrders: 0,
    type: "main_course", // Can also be considered 'rice' type if added to enum
    category: "veg",
    price: 100.00,
  ...
  },
  {
    ...
    name: "Egg Bhurji",
    numberOfOrders: 0,
    type: "starter", // Often eaten as a side or for breakfast
    category: "egg",
    price: 180.00,
  ...
  },
  {
    ...
    numberOfOrders: 0,
    type: "starter", // Often a quick side or snack
    category: "egg",
    price: 60.00,
